# app/devices/connectors/fortios_v7_0.py
...
class FortiOSV70DeviceConnector(DeviceConnector):
    """Conector optimizado para FortiOS v7.0.x."""
...
class FortiOSV70VDOMConnector(VDOMConnector):
    """Conector VDOM optimizado para FortiOS v7.0.x."""
    ...
    async def test_connectivity(self) -> ConnectivityCheckResult:
        try:
            ...
            return ConnectivityCheckResult(
                is_reachable=True, status_code=200, version=None, serial=None, message=f"VDOM {self.vdom} OK (v7.0)"
            )
        except Exception as e:
            return ConnectivityCheckResult(
                is_reachable=False, status_code=500, version=None, serial=None, message=str(e)
